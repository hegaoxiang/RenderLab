...
private:
	...
	ComPtr<ID3D11ComputeShader> m_pTexture_Test;

	ComPtr<ID3D11ShaderResourceView> m_pTextureInputA;
	ComPtr<ID3D11ShaderResourceView> m_pTextureInputB;
	
	ComPtr<ID3D11ShaderResourceView> m_pTextureInputA_UAV;
	ComPtr<ID3D11ShaderResourceView> m_pTextureInputB_UAV;
	...
	ComPtr<ID3D11Texture2D> m_pTextureOutputC;
	ComPtr<ID3D11UnorderedAccessView> m_pTextureOutputC_UAV;
};
